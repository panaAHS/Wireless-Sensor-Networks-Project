   ...
   /* if( analogRead(A3) < 500){
      ...
      /*if( analogRead(gas_sensor) < 400){
        ...
        for(int j = 700; j>300; j--){
          ...
          lcd.print("STOP! FIRE!");
          lcd.setCursor(1,1); //First line
          lcd.print("Plirotita " + String(plirotita) + "/" + String(max_plirotita));
         }*/
  
          
    
    
    if(analogRead(input_button) < 100){
      plirotita += 1;
      if(plirotita > max_plirotita){
         ...
         /* lcd.clear();
          ...
          lcd.print("P1: " + String(free_slots));*/
            delay(3000);
        // while(analogRead(input_sensor) < 800){
             // delay(1);
           // }
          //if(analogRead(input_sensor) > 800){
              s.write(0);
    ...
    else if(analogRead(exit_button) < 100 && (plirotita > 0)){
      delay(1000);
      plirotita -= 1;
      Serial.println(String(analogRead(exit_button)) + "=============/" + String(max_plirotita));
      //if(/*digitalRead(Touchsensor) == 1 &&*/ (plirotita > 0))
      {
         ...
         lcd.print("P1: " + String(free_slots));*/
          delay(3000);
          /////////////////////////////////////NA ALLAXTEI OTAN EXV TOYS AISTHTHRES!!!!!!!!!!!
